...
- C# / .NET 10.0 (GA) (001-decisionspecs-crud)
- File-based JSON persistence in Config/DecisionSpecs directory with file locking, version metadata, soft-delete archival folders, and append-only audit logs. No database required. (001-decisionspecs-crud)
...
## Recent Changes
- 001-decisionspecs-crud: Added C# / .NET 10.0 (GA)
